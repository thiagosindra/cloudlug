...
private class Capture(
    ...
    private fun readme(directory: File): String {
        ...
        return buildString {
            ...
            appendLine("enumeration tests check survives. `rev`, `content_hash`, `session_id` and")
            appendLine("timestamps are kept verbatim: none of them names a person or a place, and the")
